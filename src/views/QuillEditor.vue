<template>
  <div v-title="'富文本编辑器'">
    <el-card>
      <p>
        1. 实现：请参考
        <a style="color: #409eff" href="https://www.awesomes.cn/repo/surmon-china/vue-quill-editor">
          vue-quill-editor
        </a>
      </p>
      <p>
        2. 示例：以下示例源代码见
        <a href="https://github.com/TKBnice/vuecli3-res/blob/master/src/views/QuillEditor.vue"
          style="color: #409eff" target="_blank">
          https://github.com/TKBnice/vuecli3-res/blob/master/src/views/QuillEditor.vue
        </a>
      </p>
